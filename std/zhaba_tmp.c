...
i64 __ZH_LOP_lambda_990_i64R(i64* v991);
bool __ZH_LOP_lambda_993_i64R(i64* v994);
...
int main(int argc, char *argv[]) {
  __ZH_TYPE_Vec_lessi64_greater v999;
  __ZH_TYPE_Vec_lessi64_greater v998;
  __ZH_TYPE_Vec_lessi64_greater v996;
  i64(*v992)(i64*);
  ((v992)=(__ZH_LOP_lambda_990_i64R));
  ((v999)=(__ZH_BOP__dotcall_dotmap_Vec_lessi64_greaterPF_lessi64_spacei64R_greater((&(*(((v998)=(__ZH_BOP__dotcall_dotfilter_Vec_lessi64_greaterPF_lessbool_spacei64R_greater((&(*(((v996)=(__ZH_LOP_iota_i64i64(((i64)0), ((i64)10)))), (&(v996))))), (__ZH_LOP_lambda_993_i64R)))), (&(v998))))), (v992))));
  (__ZH_LOP_out_Vec_lessi64_greaterR(&(v999)));
  (__ZH_BOP__dotcall_dotdtor_Vec_lessi64_greaterP((&(v996))));
  (__ZH_BOP__dotcall_dotdtor_Vec_lessi64_greaterP((&(v998))));
  (__ZH_BOP__dotcall_dotdtor_Vec_lessi64_greaterP((&(v999))));
}
i64 __ZH_LOP_lambda_990_i64R(i64* v991) {{
  return (((*v991))*((*v991)));
};printf("%s", "reached function end without returning anything lop i64 lambda_990 i64R i\n"); exit(EXIT_FAILURE);}
bool __ZH_LOP_lambda_993_i64R(i64* v994) {{
  return (__ZH_BOP__percent_percent_i64i64((*v994), ((i64)2)));
};printf("%s", "reached function end without returning anything lop bool lambda_993 i64R i\n"); exit(EXIT_FAILURE);}
