...
str __ZH_LOP_frog_();
f64 __ZH_LOP_sqrt_f64(f64 v627);
__ZH_TYPE_V2 __ZH_LOP_V2_f64f64(f64 v633, f64 v634);
__ZH_TYPE_V2 __ZH_BOP__plus_V2V2(__ZH_TYPE_V2 v636, __ZH_TYPE_V2 v637);
__ZH_TYPE_V2 __ZH_BOP__asterisk_V2V2(__ZH_TYPE_V2 v638, __ZH_TYPE_V2 v639);
f64 __ZH_LOP_abs_V2(__ZH_TYPE_V2 v641);
void __ZH_LOP_put_V2(__ZH_TYPE_V2 v642);
void __ZH_LOP_out_V2(__ZH_TYPE_V2 v643);
__ZH_TYPE_Out __ZH_ROP__less_V2(__ZH_TYPE_V2 v644);
__ZH_TYPE_Out __ZH_LOP__less_V2(__ZH_TYPE_V2 v645);
__ZH_TYPE_Out __ZH_BOP__less_OutV2(__ZH_TYPE_Out v646, __ZH_TYPE_V2 v647);
__ZH_TYPE_Rng __ZH_LOP_Rng_i64(i64 v648);
__ZH_TYPE_Rng __ZH_LOP_Rng_();
i64 __ZH_BOP__dotcall_dotcall_RngP_ampersand(__ZH_TYPE_Rng* v650);
...
__ZH_TYPE_Str __ZH_LOP_frog_escaped_() {{
  __ZH_TYPE_Str v625;
  ((v625)=(__ZH_LOP_Str_str(((str)""))));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"         _____ \n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"       /       \\__ \n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"     /             \\\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"   /   0    0        |\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"  |     ..            |\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"  /|        _/       /\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)" / .\\_____/         /\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"/U\\|    \\___|   |__/\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"            /  /\n")));
  (__ZH_BOP__plus_equal_StrRstr(&(v625), ((str)"            |/U\\\n")));
  return (v625);
  (__ZH_BOP__dotcall_dotdtor_StrP_ampersand((&(v625))));
};printf("%s", "reached function end without returning anything lop Str frog_escaped\n"); exit(EXIT_FAILURE);}
__ZH_TYPE_Str __ZH_LOP_frog_escaped_multiline_() {{
  __ZH_TYPE_Str v626;
  ((v626)=(__ZH_LOP_Str_str(((str)""))));
  (__ZH_BOP__plus_equal_StrRstr(&(v626), ((str)"         _____         \n       /       \\__     \n     /             \\   \n   /   0    0        | \n  |     ..            |\n  /|        _/       / \n / .\\_____/         /\n/U\\|    \\___|   |__/\n            /  /\n            |/U\\")));
  return (v626);
  (__ZH_BOP__dotcall_dotdtor_StrP_ampersand((&(v626))));
...
f64 __ZH_LOP_sqrt_f64(f64 v627) {{
  ...
  ((v628)=((f64)1.000000));
  {
      ...
      ((v629)=(__ZH_BOP__dot_dot_i64i64(((i64)0), ((i64)10))));
      ...
      while ((__ZH_BOP__dotcall_dotuneq_i64P_ampersandi64((&(v632)), (v631)))) {
        (__ZH_BOP__minus_equal_f64Rf64(&(v628), (((((((v628))*((v628))))-((v627))))/(((((f64)2.000000))*((v628)))))));
...
__ZH_TYPE_V2 __ZH_BOP__plus_V2V2(__ZH_TYPE_V2 v636, __ZH_TYPE_V2 v637) {{
  (__ZH_BOP__plus_equal_f64Rf64(&((&(v636))->x), ((&(v637))->x)));
  (__ZH_BOP__plus_equal_f64Rf64(&((&(v636))->y), ((&(v637))->y)));
  return (v636);
};printf("%s", "reached function end without returning anything op V2 + V2 a V2 b\n"); exit(EXIT_FAILURE);}
__ZH_TYPE_V2 __ZH_BOP__asterisk_V2V2(__ZH_TYPE_V2 v638, __ZH_TYPE_V2 v639) {{
  __ZH_TYPE_V2 v640;
  (((&(v640))->x)=((((((&(v638))->x))*(((&(v639))->x))))-(((((&(v638))->y))*(((&(v639))->y))))));
  (((&(v640))->y)=((((((&(v638))->x))*(((&(v639))->y))))+(((((&(v638))->y))*(((&(v639))->x))))));
  return (v640);
};printf("%s", "reached function end without returning anything op V2 * V2 a V2 b\n"); exit(EXIT_FAILURE);}
f64 __ZH_LOP_abs_V2(__ZH_TYPE_V2 v641) {{
  return (__ZH_LOP_sqrt_f64(((((((&(v641))->x))*(((&(v641))->x))))+(((((&(v641))->y))*(((&(v641))->y)))))));
...
__ZH_TYPE_Out __ZH_BOP__less_OutV2(__ZH_TYPE_Out v646, __ZH_TYPE_V2 v647) {{
  ((__ZH_LOP_put_V2((v647))), (printf("%s", ((str)" "))));
  return (__ZH_LOP_Out_());
...
i64 __ZH_BOP__dotcall_dotcall_RngP_ampersand(__ZH_TYPE_Rng* v650) {{
  ((((v650))->seed)=((((((i64)8253729))*((((v650))->seed))))+(((i64)2396403))));
  return (((((v650))->seed))%(((i64)32767)));
