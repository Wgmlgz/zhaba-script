...
str __ZH_LOP_frog_();
f64 __ZH_LOP_sqrt_f64(f64 v962);
__ZH_TYPE_V2 __ZH_LOP_V2_f64f64(f64 v967, f64 v968);
__ZH_TYPE_V2 __ZH_BOP__plus_V2V2(__ZH_TYPE_V2 v970, __ZH_TYPE_V2 v971);
__ZH_TYPE_V2 __ZH_BOP__asterisk_V2V2(__ZH_TYPE_V2 v972, __ZH_TYPE_V2 v973);
f64 __ZH_LOP_abs_V2(__ZH_TYPE_V2 v975);
void __ZH_LOP_put_V2(__ZH_TYPE_V2 v976);
void __ZH_LOP_out_V2(__ZH_TYPE_V2 v977);
__ZH_TYPE_Out __ZH_ROP__less_V2(__ZH_TYPE_V2 v978);
__ZH_TYPE_Out __ZH_LOP__less_V2(__ZH_TYPE_V2 v979);
__ZH_TYPE_Out __ZH_BOP__less_OutV2(__ZH_TYPE_Out v980, __ZH_TYPE_V2 v981);
__ZH_TYPE_Rng __ZH_LOP_Rng_i64(i64 v982);
__ZH_TYPE_Rng __ZH_LOP_Rng_();
i64 __ZH_BOP__dotcall_dotcall_RngP(__ZH_TYPE_Rng* v984);
...
bool __ZH_BOP__less_Vec_lessi64_greaterRVec_lessi64_greaterR(__ZH_TYPE_Vec_lessi64_greater* v719, __ZH_TYPE_Vec_lessi64_greater* v720) {{
 ...
 else if ((((*__ZH_BOP__dotcall_dotsub_Vec_lessi64_greaterPi64((&(*v719)), (v723))))>((*__ZH_BOP__dotcall_dotsub_Vec_lessi64_greaterPi64((&(*v720)), (v723)))))) {
          return ((bool)0);
        }
...
bool __ZH_BOP__less_Vec_lesschar_greaterRVec_lesschar_greaterR(__ZH_TYPE_Vec_lesschar_greater* v856, __ZH_TYPE_Vec_lesschar_greater* v857) {{
 ...
 else if ((((*__ZH_BOP__dotcall_dotsub_Vec_lesschar_greaterPi64((&(*v856)), (v860))))>((*__ZH_BOP__dotcall_dotsub_Vec_lesschar_greaterPi64((&(*v857)), (v860)))))) {
          return ((bool)0);
        }
...
bool __ZH_BOP__less_StrRStrR(__ZH_TYPE_Str* v941, __ZH_TYPE_Str* v942) {{
 ...
 else if ((((*__ZH_BOP__dotcall_dotsub_StrPi64((&(*v941)), (v945))))>((*__ZH_BOP__dotcall_dotsub_StrPi64((&(*v942)), (v945)))))) {
          return ((bool)0);
        }
...
f64 __ZH_LOP_sqrt_f64(f64 v962) {{
  ...
  ((v963)=((f64)1.000000));
  {
      i64 v966;
      i64 v965;
      __ZH_TYPE_Range_lessi64_greater v964;
      ((v964)=(__ZH_LOP_iter_Range_lessi64_greater((__ZH_BOP__dot_dot_i64i64(((i64)0), ((i64)10))))));
      ((v965)=(__ZH_BOP__dotcall_dotend_Range_lessi64_greaterP((&(v964)))));
      ((v966)=(__ZH_BOP__dotcall_dotbegin_Range_lessi64_greaterP((&(v964)))));
      while ((((v966))!=((v965)))) {
        (__ZH_BOP__minus_equal_f64Rf64(&(v963), (((((((v963))*((v963))))-((v962))))/(((((f64)2.000000))*((v963)))))));
        (*__ZH_LOP__plus_plus_i64R(&(v966)));
      }
    }
  return (v963);
...
__ZH_TYPE_V2 __ZH_BOP__plus_V2V2(__ZH_TYPE_V2 v970, __ZH_TYPE_V2 v971) {{
  (__ZH_BOP__plus_equal_f64Rf64(&((&(v970))->x), ((&(v971))->x)));
  (__ZH_BOP__plus_equal_f64Rf64(&((&(v970))->y), ((&(v971))->y)));
  return (v970);
};printf("%s", "reached function end without returning anything op V2 + V2 a V2 b\n"); exit(EXIT_FAILURE);}
__ZH_TYPE_V2 __ZH_BOP__asterisk_V2V2(__ZH_TYPE_V2 v972, __ZH_TYPE_V2 v973) {{
  __ZH_TYPE_V2 v974;
  (((&(v974))->x)=((((((&(v972))->x))*(((&(v973))->x))))-(((((&(v972))->y))*(((&(v973))->y))))));
  (((&(v974))->y)=((((((&(v972))->x))*(((&(v973))->y))))+(((((&(v972))->y))*(((&(v973))->x))))));
  return (v974);
};printf("%s", "reached function end without returning anything op V2 * V2 a V2 b\n"); exit(EXIT_FAILURE);}
f64 __ZH_LOP_abs_V2(__ZH_TYPE_V2 v975) {{
  return (__ZH_LOP_sqrt_f64(((((((&(v975))->x))*(((&(v975))->x))))+(((((&(v975))->y))*(((&(v975))->y)))))));
...
i64 __ZH_BOP__dotcall_dotcall_RngP(__ZH_TYPE_Rng* v984) {{
  ((((v984))->seed)=((((((i64)8253729))*((((v984))->seed))))+(((i64)2396403))));
  return (((((v984))->seed))%(((i64)32767)));
};printf("%s", "reached function end without returning anything op i64 .call.call RngP slf\n"); exit(EXIT_FAILURE);}
int main(int argc, char *argv[]) {
  __ZH_TYPE_Vec_lessi64_greater v987;
  __ZH_TYPE_Str v988;
  __ZH_TYPE_Vec_lessi64_greater v986;
  ((v987)=(__ZH_LOP_Vec_lessi64_greater_Vec_lessi64_greaterR(&(*__ZH_BOP__comma_comma_Vec_lessi64_greaterRi64(&(*__ZH_BOP__comma_comma_Vec_lessi64_greaterRi64(&(*(((v986)=(__ZH_BOP__comma_comma_i64i64(((i64)2), ((i64)2)))), (&(v986)))), ((i64)2))), ((i64)2))))));
  ((v988)=(__ZH_LOP_Str_str(((str)"aboba ABOBA"))));
  {
      __ZH_TYPE_VecIter_lessi64_greater v991;
      __ZH_TYPE_VecIter_lessi64_greater v990;
      __ZH_TYPE_VecIterRange_lessi64_greater v989;
      ((v989)=(__ZH_LOP_iter_Vec_lessi64_greaterR(&(v987))));
      ((v990)=(__ZH_BOP__dotcall_dotend_VecIterRange_lessi64_greaterP((&(v989)))));
      ((v991)=(__ZH_BOP__dotcall_dotbegin_VecIterRange_lessi64_greaterP((&(v989)))));
      while ((__ZH_BOP__exclamation_equal_VecIter_lessi64_greaterVecIter_lessi64_greater((v991), (v990)))) {
        ((*__ZH_LOP__asterisk_VecIter_lessi64_greater((v991)))=((i64)5));
        (__ZH_LOP__plus_plus_VecIter_lessi64_greaterR(&(v991)));
      }
    }
  (__ZH_LOP__less_Out((__ZH_ROP__less_Vec_lessi64_greaterR(&(v987)))));
  (__ZH_LOP__less_Out((__ZH_ROP__less_StrR(&(v988)))));
  (__ZH_LOP_up_StrR(&(v988)));
  (__ZH_LOP__less_Out((__ZH_ROP__less_StrR(&(v988)))));
  (__ZH_LOP_low_StrR(&(v988)));
  (__ZH_LOP__less_Out((__ZH_ROP__less_StrR(&(v988)))));
  (__ZH_BOP__dotcall_dotdtor_Vec_lessi64_greaterP((&(v986))));
  (__ZH_BOP__dotcall_dotdtor_Vec_lessi64_greaterP((&(v987))));
  (__ZH_BOP__dotcall_dotdtor_StrP((&(v988))));
}
